import { PrismaClient, Role, ProductStatus, VoucherType } from '@prisma/client';
  ...
  const appleProducts = [
    {
      ...
      description:
        'iPhone 15 Pro Max. Thiết kế titan chuẩn hàng không vũ trụ. Chip A17 Pro mạnh mẽ. Camera  hệ Pro đột phá. Và nút Tác vụ tùy biến để nhanh chóng truy cập tính năng yêu thích của bạn.',
    ...
    },
    {
      ...
      description:
        'iPhone 15. Thiết kế với Dynamic Island. Camera 48MP với telephoto 2x. Sạc USB-C. Toàn bộ trong một vỏ nhôm bền bỉ và mặt lưng kính màu.',
      brandId: brands[0].id,
  ...
  const samsungProducts = [
    {
      ...
      description:
        'Galaxy S24 Ultra với Galaxy AI tích hợp, camera 200MP, bút S Pen, màn hình Dynamic AMOLED 2X 6.8 inch, chip Snapdragon 8 Gen 3 for Galaxy mạnh mẽ.',
    ...
    },
    {
      ...
      description:
        'Galaxy S24 với camera 50MP, màn hình Dynamic AMOLED 2X 6.2 inch 120Hz, chip Exynos 2400 mạnh mẽ, pin 4000mAh.',
      brandId: brands[1].id,
      categoryId: categories[0].id,
      basePrice: 19990000,
      salePrice: 18490000,
  ...
  const xiaomiProducts = [
    {
      ...
      description:
        'Xiaomi 14 Ultra - Camera Leica chuyên nghiệp với cảm biến 1 inch, chip Snapdragon 8 Gen 3, màn hình AMOLED 6.73 inch 120Hz.',
    ...
    },
    {
      ...
      description:
        'Redmi Note 13 Pro với camera 200MP, chip Snapdragon 7s Gen 2, màn hình AMOLED 120Hz, sạc nhanh 67W. Giá cực tốt.',
      brandId: brands[2].id,
  ...
  const oppoProducts = [
    {
      ...
      description:
        'OPPO Find X7 Ultra - Hệ thống camera Hasselblad với 2 telephoto periscope, chip Snapdragon 8 Gen 3, màn hình AMOLED 120Hz.',
    ...
    },
    {
      ...
      description:
        'OPPO Reno 11 - Camera chân dung 32MP, chip MediaTek Dimensity 7050, màn hình AMOLED 120Hz, thiết kế mỏng nhẹ.',
      brandId: brands[3].id,
      categoryId: categories[1].id, // Tầm trung
      basePrice: 9990000,
      salePrice: 9490000,
  ...
  const vivoProducts = [
    {
      ...
      description:
        'Vivo X100 Pro - Hệ thống camera ZEISS với telephoto APO, chip MediaTek Dimensity 9300, màn hình AMOLED 120Hz.',
    ...
    },
    {
      ...
      description:
        'Vivo V30 - Camera chân dung 50MP với OIS, chip Snapdragon 7 Gen 3, màn hình AMOLED 120Hz, thiết kế mỏng 7.5mm.',
      brandId: brands[4].id,
      categoryId: categories[1].id, // Tầm trung
      basePrice: 10990000,
      salePrice: 10490000,
